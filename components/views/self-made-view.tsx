...
interface SelfMadeViewProps {
  billionaires: Billionaire[]
}

export default function SelfMadeView({ billionaires }: SelfMadeViewProps) {
  ...
  useEffect(() => {
    ...
    const simulation = d3
      ...
      .force("y", d3.forceY((d: any) => (d.isSelfMade ? innerHeight / 4 : (3 * innerHeight) / 4)).strength(0.4))
      .force(
        "collision",
